...
rm /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HPT/bismark_alignment/*_unmapped_reads.fq.gz
rm /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HPT/bismark_alignment/*_ambiguous_reads.fq.gz