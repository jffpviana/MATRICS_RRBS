...
mkdir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HPT/bismark_alignment

cd /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HPT/trim_galore_output/
