...
mkdir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/trim_galore_output

#trim the reads
perl /gpfs/ts0/home/jfv203/software/TrimGalore-0.4.3/trim_galore -q 20  --phred33 --rrbs --gzip --fastqc_args "--outdir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/trim_galore_output" --output_dir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/trim_galore_output  /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/raw_data/combined/*.fastq

perl /gpfs/ts0/home/jfv203/software/TrimGalore-0.4.3/trim_galore -q 20  --phred33 --rrbs --gzip --fastqc_args "--outdir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/trim_galore_output" --output_dir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/trim_galore_output  /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTT_HC/raw_data/combined/*.fq
