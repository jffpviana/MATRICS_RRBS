...
perl ~/software/Bismark-0.19.0/Bismark-0.19.0/bismark_methylation_extractor  -s --gzip --comprehensive --samtools_path /gpfs/ts0/shared/software/SAMtools/1.3.1-foss-2016a/bin --multicore 4 --bedGraph *_trimmed_bismark_bt2.sam
