...
for fasta in $(ls /rds/projects/v/vianaj-genomics-brain-development/MATRICS/raw_data_test/CB2N2ANXX/*.fq | grep BLB.*ACC)
do
	name=`basename $fasta`
 echo $fasta
	file1=`ls /rds/projects/v/vianaj-genomics-brain-development/MATRICS/raw_data_test/CB2N2ANXX/*.fq | echo $fasta`

	file2=`ls /rds/projects/v/vianaj-genomics-brain-development/MATRICS/raw_data_test/CB30KANXX/*.fq | echo $fasta`
