...
cd /gpfs/ts0/scratch/jfv203/MATRICS/BLB_VMH/raw_data/CB2N2ANXX #change directory
fastqc *.fq -o /gpfs/ts0/scratch/jfv203/MATRICS/BLB_VMH/raw_data/CB2N2ANXX # run fastqc for all samples and output in the directory of the respective cohort