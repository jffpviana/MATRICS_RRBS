...
rm /gpfs/ts0/scratch/jfv203/MATRICS/BLB_VMH/bismark_alignment/*_unmapped_reads.fq.gz
rm /gpfs/ts0/scratch/jfv203/MATRICS/BLB_VMH/bismark_alignment/*_ambiguous_reads.fq.gz