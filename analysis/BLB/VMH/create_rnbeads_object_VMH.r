...
cohort <- "BLB"
region <- "VMH"
input_dir <- "/rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/VMH/methylation"
output_dir <- "/rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/VMH/analysis/"
sample_annotation <- "/rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/VMH/BLBVMH_pheno.csv"
