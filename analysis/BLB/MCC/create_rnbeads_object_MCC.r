...
cohort <- "BLB"
region <- "MCC"
input_dir <- "/rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/MCC/methylation"
output_dir <- "/rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/MCC/analysis/"
sample_annotation <- "/rds/projects/v/vianaj-genomics-brain-development/MATRICS/BLB/MCC/BLBMCC_pheno.csv"
