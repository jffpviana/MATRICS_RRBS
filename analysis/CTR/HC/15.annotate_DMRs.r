...
#load DMR objects
load(file=paste0(output_dir, "DMRs_low_vs_inter_", cohort, "_", str_replace(region, "_ID", ""), ".RData"))

load(file=paste0(output_dir, "DMRs_low_vs_high_", cohort, "_", str_replace(region, "_ID", ""), ".RData")) 
