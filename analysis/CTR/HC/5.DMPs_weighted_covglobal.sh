...
function_path="/rds/projects/v/vianaj-genomics-brain-development/MATRICS/scripts/betaRegression_weighted.r"
region="HC_ID"
cohort="CTR"


Rscript 5.DMPs_weighted_covglobal.r $input_dir $output_dir $pheno_path $function_path $region $cohort
