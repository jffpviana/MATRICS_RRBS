...
mkdir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTR_N_HC/bismark_alignment

cd /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTR_N_HC/trim_galore_output/
