...
cd /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTR_N_HPT/bismark_alignment
gunzip -d *_trimmed_bismark_bt2.sam.gz # Unzip the CTR N PFC samples (prefrontal cortex of Naive Lausanne rats)

perl ~/software/Bismark-0.19.0/Bismark-0.19.0/bismark_methylation_extractor   -s --gzip --comprehensive --bedGraph  *_trimmed_bismark_bt2.sam --samtools_path /gpfs/ts0/shared/software/SAMtools/1.5-foss-2016b/bin/
