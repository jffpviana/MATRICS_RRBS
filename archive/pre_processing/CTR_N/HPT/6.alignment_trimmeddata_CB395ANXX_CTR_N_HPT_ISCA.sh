...
mkdir /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTR_N_HPT/bismark_alignment

cd /gpfs/ts0/projects/Research_Project-129726/MATRICS/CTR_N_HPT/trim_galore_output/
