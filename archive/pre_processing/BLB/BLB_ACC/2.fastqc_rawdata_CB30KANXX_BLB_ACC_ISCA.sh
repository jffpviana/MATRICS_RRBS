...
cd /gpfs/ts0/scratch/jfv203/MATRICS/BLB_ACC/raw_data/CB30KANXX #change directory
fastqc *.fq -o /gpfs/ts0/scratch/jfv203/MATRICS/BLB_ACC/raw_data/CB30KANXX # run fastqc for all samples and output in the directory of the respective cohort