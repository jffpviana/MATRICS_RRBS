...
cd /gpfs/ts0/scratch/jfv203/MATRICS/BLB_MCC/trim_galore_output #change directory
gunzip -d *.fq.gz 
fastqc *.fq -o /gpfs/ts0/scratch/jfv203/MATRICS/BLB_MCC/trim_galore_output # run fastqc for all samples and output in the directory of the respective cohort