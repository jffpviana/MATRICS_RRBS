...
cd /gpfs/ts0/scratch/jfv203/MATRICS/BLB_MCC/raw_data/combined #change directory
fastqc *.fq -o /gpfs/ts0/scratch/jfv203/MATRICS/BLB_MCC/raw_data/combined # run fastqc for all samples and output in the directory of the respective cohort