...
cd /rds/projects/v/vianaj-genomics-brain-development/MATRICS/raw_data_test/trim_galore_output/done

bismark_genome_preparation / --verbose /rds/projects/v/vianaj-genomics-brain-development/MATRICS/genome
